...
//     super.initState();
//
//     // Mark all existing unseen messages as seen
//     _chatService.markMessagesSeen(widget.chatId);
//
//     // Listen to new messages in real-time and mark unseen messages as seen
...
//                   ),
//                 ),
//                 IconButton(onPressed: _sendMessage, icon: const Icon(Icons.send, color: Colors.pink))
//               ],
//             ),
//           ),
//         ],
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return MessageBubble(
                      ...
                      replyToText: data?['replyToText'], // Safely access optional field
