...
//   const WeddingCardsScreen({Key? key}) : super(key: key);
//
//   @override
...
//       gradient: [Color(0xFF8B4513), Color(0xFFFFB6C1)],
//     ),
//     CardTemplate(
//       title: 'Blank Garden',
//       imagePath: 'assets/wedding_card_2.jpg',
//       gradient: [Color(0xFF20B2AA), Color(0xFF98FB98)],
//     ),
//     CardTemplate(
//       title: 'Scent of summer',
//       imagePath: 'assets/wedding_card_3.jpg',
//       gradient: [Color(0xFFDEB887), Color(0xFFF0E68C)],
//     ),
//     CardTemplate(
//       title: 'Regal',
//       imagePath: 'assets/wedding_card_4.jpg',
//       gradient: [Color(0xFF2F4F4F), Color(0xFF8FBC8F)],
//     ),
//   ];
//
//   @override
...
//             selectedCulture,
//             cultureOptions,
//                 (value) => setState(() => selectedCulture = value!),
//           ),
//           const SizedBox(width: 12),
//           _buildDropdown(
//             'Theme',
...
//           return _buildCardTemplate(templates[index]);
//         },
//       ),
//     );
//   }
...
//     return Stack(
//       children: [
//         // Floral decorations for certain templates
...
//
//   const CardCustomizationScreen({Key? key, required this.template}) : super(key: key);
//
//   @override
...
//             _buildTopHeader(),
//
//             // Canvas Area with flexible height
//             Flexible(
//               flex: 3,
//               child: _buildCanvasArea(),
//             ),
//
//             // Bottom Tools with fixed height
//             _buildBottomTools(),
//
...
//                 _buildSizeButton('-', () {
//                   setState(() {
//                     cardScale = (cardScale - 0.1).clamp(0.5, 2.0);
//                   });
//                 }),
...
//   }
//
//   Widget _buildSizeButton(String text, VoidCallback onPressed) {
//     return GestureDetector(
//       onTap: onPressed,
//       child: Container(
//         width: 40,
...
//                     begin: Alignment.topLeft,
//                     end: Alignment.bottomRight,
//                     colors: widget.template.gradient,
//                   ),
//                 ),
//                 child: Stack(
//                   children: [
...
//     return Container(
//       height: 80, // Fixed height for tools
//       padding: const EdgeInsets.symmetric(vertical: 8),
...
class _CardCustomizationScreenState extends State<CardCustomizationScreen> {
  ...
  //         children: [
  //           _buildTopHeader(),
  //           Flexible(flex: 3, child: _buildCanvasArea()),
  //           _buildBottomTools(),
  //           if (_shouldShowEditPanel()) _buildEditPanel(),
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          //     mainAxisAlignment: MainAxisAlignment.center,
          //     children: [
          //       _buildSizeButton('-', () => setState(() => cardScale = (cardScale - 0.1).clamp(0.5, 2.0))),
          //       const SizedBox(width: 16),
          //       Container(
          //         padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 6),
          //         decoration: BoxDecoration(
